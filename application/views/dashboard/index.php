...
<div id="dashboard-section">
	<div>
		...
		<div class="dashboard-subsection">
			<table>
				<tr>
					<td class="dashboard-subsection-header">Overdue Credits</td>
					<td class="dashboard-subsection-content">
						<?php if (count($overdueCredits) > 0): ?>
						<ul>
							<?php foreach ($overdueCredits as $item): ?>
							<li>
                                <a href="/sales/summary/<?php echo $item['salesTransactionId'] ?>">Transaction #<?php echo $item['salesTransactionId'] ?></a>,
