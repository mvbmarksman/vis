...
class Sales extends MY_Controller
{
    ...
    public function dailysales($dateParam = null)
    {
        $this->load->helper('My_date_helper');
        $date = My_date_helper::getMysqlDate($dateParam);
        $this->load->model('Sales_transaction_model', 'stm');
        $salesTransactions = $this->stm->fetchSalesTransForTheDay($date);
        $this->renderView('dailysales', array(
